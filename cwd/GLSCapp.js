(function(cwd) {
      ...
      cwd
        ...
        .shape(
          cwd
            .pathShape()
            .coords(
              'M1920,1080 L1500,900 L1000,800 L900,400 L240,160 L160,40 L80,80 L-1000,300'
            )
        )
    );
  };
  ...
  const gaugeone = () => {
    let content = cwd
      .svgImageShape()
      .url(
        'https://oberlin.environmentaldashboard.org/gauges/gauge.php?rv_id=2998&meter_id=2961&color=%23ecf0f1&bg=%2321a7df&height=190&width=290&font_family=Futura%2C+Helvetica%2C+sans-serif&title=Electricity+use&title2=&border_radius=3&rounding=0&ver=svg&units='
      )
      .size('20%');
  ...
  const gaugetwo = () => {
    let content = cwd
      .svgImageShape()
      .url(
        'https://oberlin.environmentaldashboard.org/gauges/gauge.php?rv_id=2999&meter_id=2964&color=%23ecf0f1&bg=%2321a7df&height=190&width=290&font_family=Futura%2C+Helvetica%2C+sans-serif&title=Water+use&title2=&border_radius=3&rounding=0&ver=svg&units='
      )
      .size('20%');
  ...
  const gaugethree = () => {
    let content = cwd
      .svgImageShape()
      .url(
        'https://oberlin.environmentaldashboard.org/gauges/gauge.php?rv_id=3000&meter_id=2969&color=%23ecf0f1&bg=%2321a7df&height=190&width=290&font_family=Futura%2C+Helvetica%2C+sans-serif&title=Gas+use&title2=&border_radius=3&rounding=0&ver=svg&units='
      )
      .size('20%');
  ...
  const gaugefour = () => {
    let content = cwd
      .svgImageShape()
      .url(
        'https://oberlin.environmentaldashboard.org/gauges/gauge.php?rv_id=3001&meter_id=2962&color=%23ecf0f1&bg=%2321a7df&height=190&width=290&font_family=Futura%2C+Helvetica%2C+sans-serif&title=Production+%28wind%29&title2=&border_radius=3&rounding=0&ver=svg&units='
      )
      .size('20%');
  ...
  const turbines = () => {
    ...
    return Object.assign(
      ...
      cwd.glyph(state),
      cwd.graphic(state).shape(content),
      cwd.fx([cwd.rotator(state).duration(4000)])
    );
  };
